/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6a520b56927e60583b3ad495c2b639e6)
// Runtime types generated with workerd@1.20260508.1 2026-05-12 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "CodexSessionObject";
	}
	interface Env {
		OPENAI_BASE_URL: "https://api.openai.com/v1";
		OPENAI_API_KEY: string;
		CODEX_SESSIONS: DurableObjectNamespace<import("./src/worker/index").CodexSessionObject>;
	}
}
